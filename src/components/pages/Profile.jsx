...
import { MapPin, Mail, Circle, Smartphone, Cake, Hourglass } from "lucide-react";
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                ...
                <div className="md:col-span-2 md:pl-6 md:border-l border-muted flex flex-col items-center text-center">
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 pt-4 text-sm text-muted-foreground text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="shadow-sm">
              <CardContent className="p-4 space-y-3">
                ...
                />
                <div>
                  <h5 className="text-lg font-medium text-foreground">Project Phoenix</h5>
                  <p className="text-sm text-muted-foreground">Role: Frontend Developer</p>
                </div>
